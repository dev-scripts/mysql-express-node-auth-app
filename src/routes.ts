...
const models: TsoaRoute.Models = {
    ...
    "ResetPasswordRequest": {
        ...
        "properties": {
            ...
            "passwordResetHash": {"dataType":"string","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/auth/token/:refreshToken',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.token)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/auth/verify/:emailVerificationCode',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...
            const args = {
                    emailVerificationCode: {"in":"path","name":"emailVerificationCode","required":true,"dataType":"string"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/auth/sendPasswordResetLink',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...
            const args = {
                    req: {"in":"body","name":"req","required":true,"ref":"ResetPasswordLinkRequest"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/auth/isValidPasswordResetLink/:passwordResetHash',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.isValidPasswordResetLink)),

            function AuthController_isValidPasswordResetLink(request: any, response: any, next: any) {
            const args = {
                    passwordResetHash: {"in":"path","name":"passwordResetHash","required":true,"dataType":"string"},
            };
            ...
            try {
              ...
              const promise = controller.isValidPasswordResetLink.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/auth/passwordReset',
            ...
            function AuthController_passwordReset(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"body","name":"req","required":true,"ref":"ResetPasswordRequest"},
            };
            ...
            try {
              ...
              const promise = controller.passwordReset.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
